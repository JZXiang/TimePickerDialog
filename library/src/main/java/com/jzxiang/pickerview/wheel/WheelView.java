...
//        mPaintLineRight.setStrokeWidth(context.getResources().getDimensionPixelSize(R.dimen.picker_line_width));
        ...
        defaultColor = context.getResources().getColor(DefaultConfig.TV_NORMAL_COLOR_ID);
        selectorColor = context.getResources().getColor(DefaultConfig.TV_SELECTOR_COLOR_ID);
    ...
    public void setConfig(PickerConfig config) {
        ...
        defaultColor = getContext().getResources().getColor(config.mWheelTVNormalColorId);
        selectorColor = getContext().getResources().getColor(config.mWheelTVSelectorColorId);
    }
